# Testing the data to see if it is clean and if it is then we can run the full generate_training_data.py
# on the full 27 assets 
...
def run_industrial_forge():
    ...
    factory = FeatureFactory(raw_dir='data/raw')
     # 
    # We force the factory to only "see" EURUSD for this test run
    # factory.asset_list = ['EURUSD_M1.csv', 'GBPAUD_M1.csv', 'NZDUSD_M1.csv', 'AUDJPY_M1.csv'] 
    factory.asset_list = ['EURCAD_M1.csv'] 
    output_path = "data/EURCAD_M1_v4.parquet"
